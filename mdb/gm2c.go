...
type Config struct {
	Skip bool
	// TTL is the time to live in seconds, default is 0, means no expire
	TTL    int64
	Prefix string
	Store  CacheStore
}
...
var PCacheStat = new(PluginCacheStat)
...
var localSingleFlight = singleflight.Group{}
